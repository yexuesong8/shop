<template>
  ...
  <div class="main-content-container full-fill">
    <Page
      ref="page"
      list-api="/api/v1/rabbit/data/category/find/page"
      base-api="/api/v1/rabbit/data/category"
      :toolbar-buttons="[
      ...
      :form="{
        ...
        items: [
          ...
          { component: { name: 'drop-down-tree', props: { 'data-source-uri': '/api/v1/rabbit/data/category/find/tree', 'source-type': 'uri' }, }, span: 8, props: { label: '分类', prop: 'parentId' } },
        ...
        columns: [
          ...
          { label: '上级分类', prop: 'parentId', formatter: (row) => row.parentName },{
            ...
            handlers: [
              ...
              { type: 'delete', props: { api: '/api/v1/rabbit/data/category/delete', type: 'button',confirmMessageFormatter: (row) => ({ title: '删除', message: `确定要删除吗?` })} },
            ],
          },
        ]
      }"
        ...
        props: {
          ...
          form: {
            ...
            items: [
              ...
              { component: { name: 'drop-down-tree', props: { 'data-source-uri': '/api/v1/rabbit/data/category/find/tree','source-type':'uri' }, }, span: 24, props: { label: '上级分类', prop: 'parentId' }, },
            ],
          },
        },
        events: {
...
const validateCode = (rule, value, callback) => {
  ...
  if (!value) {
    ...
    callback('请输入正确的编码,支持大小写英文字母、数字、下划线_、短横线-');
  } else {
    callback();
  }
};
