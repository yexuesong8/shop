<template>
  <component :is="getComponent(component)" v-if="data.trim || data.trim === undefined" v-model.trim="model" :data="form" v-bind="getComponentProps(component)" v-on="getComponentEvents(component)" />
  <component :is="getComponent(component)" v-else v-model="model" :data="form" v-bind="getComponentProps(component)" v-on="getComponentEvents(component)" />
</template>

<script>
import FormItemComponent from "./component.js";
            ...
            const newArgs = [
              {
                ...
                getFormValue: self.getFormValue,
                data: self.provideCustomData,
              },
              ...args,
            ];
            event(...newArgs);
