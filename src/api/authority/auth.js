...
// 获取列表
export const getObject = (data) => request({
...
export const getById = (id) => request({
  url: "/rabbit/system/data/auth/get",
  data: { id },
});

// 创建
export const add = (data) => request({
  url: "/rabbit/system/data/auth/create",
  data,
});

// 更新
export const update = (data) => request({
  url: "/rabbit/system/data/auth/update",
  data,
});

// 删除
export const del = (data) => request({
  url: "/rabbit/system/data/auth/delete",
  data,
});
